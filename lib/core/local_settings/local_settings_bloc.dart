...
class LocalSettingsBloc
  ...
  void _onToggleTheme(ToggleTheme event, Emitter<LocalSettingsState> emit) {
  ...
  void _onChangeColorScheme(
      ChangeColorScheme event, Emitter<LocalSettingsState> emit) {
    emit(state.copyWith(colorScheme: event.newScheme));
  }
