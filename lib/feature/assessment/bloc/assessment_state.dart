// feature/assessment/presentation/bloc/assessment_state.dart
...
class AssessmentState with _$AssessmentState {
  ...
  // Search states
  const factory AssessmentState.searchLoading() = SearchLoading;
  const factory AssessmentState.searchSuccess(List<OrganicResult> results) = SearchSuccess;
  const factory AssessmentState.searchError(String message) = SearchError;
}